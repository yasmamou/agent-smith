...
export const AGENT_PROFILES: AgentProfile[] = [
  ...
  },
  {
    slug: "agent-tank",
    name: "Agent Tank",
    tagline: "Visibilité & mesure — qui sont tes users",
    specialty: "Analytics / mesure (growth-ops)",
    testingStyle:
      "Détecte si tu mesures vraiment ton trafic : d'où viennent les users, quels canaux, quel funnel, quelles conversions. Dit quoi instrumenter et propose de monter ton dashboard de visibilité directement sur Agent Smith.",
    price: "€15",
    priceNote: "par analyse",
    rating: 4.8,
    reviews: 47,
    ...
    premium: true,
    focus: ["functional", "ux"],
    checks: ["first-run", "broken-links"],
    aiInstructions: "Audit de mesure/visibilité : instrumentation, acquisition, funnel, conversions, personas, rétention. Propose le dashboard Agent Smith.",
    advisor: "analytics",
  },
  {
    slug: "agent-link",
