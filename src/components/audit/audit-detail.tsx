      ...
      {audit.strategy && (
        <div className="glass-bright mb-6 rounded-2xl p-5" style={{ borderColor: "#b388ff55" }}>
          <h3 className="mb-1 flex items-center gap-2 text-sm font-semibold" style={{ color: "#c9abff" }}>
            {audit.strategy.lens === "sales" ? "💎 Vente & conversion (CRO)" : audit.strategy.lens === "design" ? "🔮 Design & craft UI" : audit.strategy.lens === "ceo" ? "🕴️ Vision CEO & arbitrages" : "🧠 Stratégie produit & plateforme"}
